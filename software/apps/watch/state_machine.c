...
{
    current_state = STATE_WATCH_FACE_BLE_OFF;
...
void state_machine_refresh_screen()
{
    switch (current_state) {
        case STATE_WATCH_FACE_BLE_OFF:
        case STATE_WATCH_FACE_BLE_ON:
            buildWatchFace_LCD();
            break;
...
void state_machine_on_button_1()
{
    switch (current_state) {
        case STATE_WATCH_FACE_BLE_OFF:
            ...
            lcd_builder_bluetooth_enabled = true;
            current_state = STATE_WATCH_FACE_BLE_ON;
            break;
